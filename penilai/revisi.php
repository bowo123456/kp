...
if(isset($_POST['update'])){
  include '../koneksi.php';
    $SQL = $db->prepare("UPDATE tabel_formulir_skp SET kegiatan_tugas_jabatan=?,kuantitas=?,output=?,kualitas=?,waktu=?,biaya=?,status=? WHERE id_skp=?");

    $SQL->bind_param("sssssssi",$_POST['kegiatan_tugas_jabatan'],$_POST['kuantitas'],$_POST['output'],$_POST['kualitas'],$_POST['waktu'],$_POST['biaya'],$_POST['status'],$_GET['edit']);
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="4" name="kegiatan_tugas_jabatan" placeholder="Masukkan kegiatan tugas jabatan ..." style="width: 60%;" required=""></textarea>
                </div>
                <div class="form-group">
                  <label >Kuantitas</label>
                  <input type="number" class="form-control" name="kuantitas" style="width: 20%;" required="">
                </div>
                <div class="form-group">
                  <label >Output</label>
                  <select name="output" class="form-control" style="width: 50%;" required="">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="kualitas" style="width: 20%;" required="">
                </div>
                 <div class="form-group">
                  <label >Waktu (bulan)</label>
                  <input type="number" class="form-control" name="waktu" style="width: 20%;" required="">
                </div>
                 <div class="form-group">
                  <label >Biaya</label>
                  <input type="number" class="form-control" name="biaya" style="width: 50%;" required="">
                </div>
                </div>
                <div class="form-group">
                  <label >Status</label>
                  <select name="status" class="form-control" style="width: 50%;" required="">
                    ...
                    <option value="Revisi ke-1" >Revisi ke-1</option>
                    <option value="Revisi ke-2" >Revisi ke-2</option>
                    <option value="Revisi ke-3" >Revisi ke-3</option>
                  </select>
                </div>
                <button type="submit" name="update" value="update" class="btn btn-success">Simpan Revisi</button>    
              </div>
            </div>
          </form>
      </div>
