<?php
  if(isset($_POST['btn_simpan'])){
    ...
    $sql = "INSERT INTO tabel_user (nip, nama, jabatan, unit_kerja, password)
    VALUES ('$nip','$nama','$jabatan','$unit_kerja','$password')";
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="#"><i class="fa fa-link"></i> <span>Kelola Data Akun Pegawai</span></a></li>
        <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Kelola Data Pegawai</span></a></li>
        <li class=""><a href="#"><i class="fa fa-link"></i> <span>Kelola Data Admin</span></a></li>
        <li class="treeview">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label >NIP</label>
                  <input type="text" class="form-control" name="nip" placeholder="Masukkan NIP" style="width: 50%;">
                </div>
                <div class="form-group">
                  <label >Nama</label>
                ...
                <div class="form-group">
                  ...
                  <select name="pangkat_golongan" class="form-control" style="width: 50%;">
