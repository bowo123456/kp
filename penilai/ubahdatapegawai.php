...
if(isset($_POST['update'])){
  ...
  $SQL = $db->prepare("UPDATE tabel_user SET nama=?,pangkat_golongan=?,jabatan=?,unit_kerja=? WHERE nip=?");

  $SQL->bind_param("ssssi",$_POST['nama'],$_POST['pangkat_golongan'],$_POST['jabatan'],$_POST['unit_kerja'],$_GET['edit']);
