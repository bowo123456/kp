    ...
    <section class="content container-fluid">
        <div class="box">
            ...
            <div class="box-header">
                <a href="tambahdatapegawai.php"  type="button" class="btn btn-success">Tambah Pegawai</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              ?>
                <tr role="row" class="odd">
                  ...
                  <td>
                      <a href="ubahdatapegawai.php?edit=<?php echo $row['nip']; ?>"  type="button" class="btn btn-default">Ubah</a>
