...
if(isset($_POST['update'])){
  ...
  $SQL = $db->prepare("UPDATE tabel_user SET nama=?,jabatan=?,unit_kerja=?,password=? WHERE status='Admin' ");

  $SQL->bind_param("ssssi",$_POST['pangkat_golongan'],$_POST['jabatan'],$_POST['unit_kerja'],$_POST['password'],$_GET['edit']);
...
<head>
  ...
  <title>Ubah Data Admin | Admin</title>
