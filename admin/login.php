...
<?php
    ...
    include '../koneksi.php';
    $result = mysqli_query($db,"SELECT * FROM tabel_user WHERE nip = '$nip' and password = '$password' and status = 'Admin' ") ;
    ...
    if ($no_of_rows > 0) {
      ...
      $_SESSION['nip_admin']=$result['nip'];
      $_SESSION['nama_admin']=$result['nama'];
      $_SESSION['status_admin']=$result['status'];
