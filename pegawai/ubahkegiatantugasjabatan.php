...
if(isset($_POST['btn_simpan'])){
      ...
      $sql = "UPDATE tabel_formulir_skp set kegiatan_tugas_jabatan='$kegiatan_tugas_jabatan',kuantitas=$kuantitas,output='$output',kualitas=$kualitas,waktu=$waktu,biaya=$biaya where id_skp=$id ";
...
$query = "SELECT * FROM tabel_formulir_skp where id_skp=$id";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Ubah Kegiatan Tugas Jabatan 
      </h1>
        <form action="" method="POST">

          <input type="hidden" name="id_skp" value="<?php echo $_GET['edit']; ?>">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  <label >Kegiatan Tugas Jabatan</label>
                  <textarea class="form-control" rows="4" name="kegiatan_tugas_jabatan" placeholder="Masukkan kegiatan tugas jabatan ..." required="" style="width: 60%;"><?php echo $row['kegiatan_tugas_jabatan']; ?>
                  </textarea>
                </div>
                <div class="form-group">
                  <label >Kuantitas</label>
                  <input type="number" class="form-control" required="" value="<?php echo $row['kuantitas']; ?>" name="kuantitas" style="width: 20%;">
                </div>
                <div class="form-group">
                  <label >Output</label>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" required="" name="kualitas" value="<?php echo $row['kuantitas']; ?>" style="width: 20%;">
                </div>
                 <div class="form-group">
                  <label >Waktu (bulan)</label>
                  <input type="number" required="" class="form-control" name="waktu" value="<?php echo $row['waktu']; ?>" style="width: 20%;">
                </div>
                 <div class="form-group">
                  <label >Biaya</label>
                  <input type="number" class="form-control" required="" name="biaya" value="<?php echo $row['biaya']; ?>"  style="width: 50%;">
                </div>
                <button type="submit" name="btn_simpan" class="btn btn-success" name="update" value="update">Simpan</button>    
              </div>
            </div>
          </form>
      </div>
